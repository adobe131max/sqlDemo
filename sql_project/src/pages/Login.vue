<template>
    <div class="login">
        ...
        <div class="card">
            <form class="form_container card2">
                ...
                <div class="input_container">
                    ...
                    <input v-model="username" placeholder="username" title="Inpit title" name="input-name" type="text" class="input_field" id="email_field">
                </div>
                <div class="input_container">
                    ...
                    <input v-model="password" placeholder="Password" title="Inpit title" name="input-name" type="password" class="input_field" id="password_field">
                </div>
                <button @click="login" type="button" title="Sign In" class="sign-in_btn">
                    <span>Sign In</span>
                </button>
                ...
                <button type="button" title="Sign In" class="sign-in_ggl">
                ...
                <button type="button" title="Sign In" class="sign-in_apl">
...
export default {
    ...
    methods: {
        login() {
            ...
            axios.post('http://localhost:9001/login', jsonData, {
                headers: {
